...
Select Case lCase(Parameter("str_Instance"))
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "project"
		targetUrl = GetResource("ActiveWorkspace2406_Data.xml").GetValue("PROJECT")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "prod"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("PROD")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "prod-nonsso"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("PROD-NonSSO")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "int2406" 
		targetUrl = GetResource("ActiveWorkspace2406_Data.xml").GetValue("INT2406")
	'--------------------------------------------------------------------------------------------------------------------------------	
	Case "int2" 
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("INT2")
	'--------------------------------------------------------------------------------------------------------------------------------	
	Case "int1" 
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("INT1")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "pre"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("PRE")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "pre-nonsso"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("PRE-NONSSO")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "cloud"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("CLOUD")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case "int2-nonsso"
		targetUrl = GetResource("ActiveWorkspace_Data.xml").GetValue("INT2-NONSSO")
	'--------------------------------------------------------------------------------------------------------------------------------
	Case Else 
			ExitComponent
	'--------------------------------------------------------------------------------------------------------------------------------			
...
If  lCase(Parameter("str_Instance"))="project"or lCase(Parameter("str_Instance"))="int2-nonsso" or lCase(Parameter("str_Instance"))="int2"  or  lCase(Parameter("str_Instance"))="cloud"  or  lCase(Parameter("str_Instance"))="int2406" Then
	...
	'--------------------------------------------------------------------------------------------------------------------------------
	If Parameter("str_UserName")<>"" Then
		sPassword=GetResource("ActiveWorkspace2406_UserDetails.xml").GetValue(Parameter("str_UserName"))
		If sPassword="" Then
